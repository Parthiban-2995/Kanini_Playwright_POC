...
Call log:
  - waiting for locator('table#DataTables_Table_0').locator('tbody tr').filter({ hasText: 'SARATH (1234)' }).first().locator('a[aria-label="Show"]')
    - locator resolved to <a href="#" aria-label="Show" data-bs-toggle="tooltip" onclick="viewDetail(7848)" data-bs-target="#viewModal" data-bs-original-title="Show" class="btn btn-secondary btn-sm">…</a>
  - attempting hover action
    2 × waiting for element to be visible and stable
      - element is visible and stable
      - scrolling into view if needed
      - done scrolling
      - <td class=" dt-body-right">…</td> intercepts pointer events
    ...
    - retrying hover action
      - waiting 100ms
    37 × waiting for element to be visible and stable
       - element is visible and stable
       - scrolling into view if needed
       - done scrolling
       - <td class=" dt-body-right">…</td> intercepts pointer events
          ...
          - generic [ref=f2e203]:
            ...
            - grid [ref=f2e229]:
              ...
              - rowgroup [ref=f2e247]:
                ...
                - row [ref=f2e267]:
                  - gridcell [ref=f2e268]:
                    - link "SARATH (1234)" [ref=f2e269] [cursor=pointer]:
                      - /url: https://demo.smart-hospital.in/admin/patient/profile/1234
                  - gridcell [ref=f2e270]:
                    - link "APPNO7849" [ref=f2e271] [cursor=pointer]:
                      - /url: https://demo.smart-hospital.in/admin/patient/profile/1234
                  - gridcell "23/09/2026 12:43 PM" [ref=f2e272]
                  - gridcell [ref=f2e273]
                  - gridcell "Male" [ref=f2e274]
                  - gridcell "Sansa Gomez (9008)" [ref=f2e275]
                  - gridcell "Offline" [ref=f2e276]
                  - gridcell "Normal" [ref=f2e277]
                  - gridcell "No" [ref=f2e278]
                  - gridcell "PATIENT_ADDRESS" [ref=f2e279]
                  - gridcell "Jason Abbot (9017)" [ref=f2e280]
                  - gridcell "Approved" [ref=f2e281]
                  - gridcell "147.60" [ref=f2e283]
                  - gridcell "14.76 (10.00 %)" [ref=f2e284]
                  - gridcell "159.41 Show Print Reschedule" [ref=f2e285]:
                    - text: "159.41"
                    - generic:
                      - link "Show":
                        - /url: "#"
                      ...
                      - link "Reschedule":
                        - /url: "#"
                        - generic: 
            - status [ref=f2e286]: "Records: 1 to 2 of 2"
            - list [ref=f2e288]:
              - listitem [ref=f2e289]:
                - link "" [disabled]
              - listitem [ref=f2e290] [cursor=pointer]:
                - link "1" [ref=f2e291]:
                  - /url: "#"
              - listitem [ref=f2e292]:
                - link "" [disabled]
...
```ts
  ...
  118 | 
  119 |     const showButton = appointmentRow.locator('a[aria-label="Show"]');
> 120 |     await showButton.hover();
      |                      ^ Error: locator.hover: Test timeout of 30000ms exceeded.
  121 |     await showButton.click();
  122 | 
  123 |     const deleteButton = this.appointmentTable.page().locator('a[aria-label="Delete"]:visible');
