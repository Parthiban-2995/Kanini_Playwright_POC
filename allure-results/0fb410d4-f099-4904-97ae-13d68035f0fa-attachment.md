        ...
        - generic [ref=f2e262]:
          ...
          - generic [ref=f2e264]:
            - generic [ref=f2e265]:
              ...
              - combobox [ref=f2e269] [cursor=pointer]
            - generic [ref=f2e270] [cursor=pointer]:
              - generic [ref=f2e271]: 
              - generic [ref=f2e272]: New Patient
          - button "Close" [ref=f2e273] [cursor=pointer]
        - generic [ref=f2e276]:
          - generic [ref=f2e277]: Appointment Details
          - generic [ref=f2e280]:
            - generic [ref=f2e281]:
              - generic [ref=f2e282]: Doctor
              - text: "*"
              - combobox [aria-hidden] [ref=f2e283]
              - combobox "Select" [ref=f2e286] [cursor=pointer]
            - generic [ref=f2e288]:
              - generic [ref=f2e289]: Doctor Fees ($)
              - text: "*"
              - textbox [ref=f2e290]
            - generic [ref=f2e291]:
              - generic [ref=f2e292]: Shift
              - text: "*"
              - combobox [aria-hidden] [ref=f2e293]
              - combobox "Select" [ref=f2e296] [cursor=pointer]
            - generic [ref=f2e298]:
              - generic [ref=f2e299]: Appointment Date
              - text: "*"
              - textbox [ref=f2e300] [cursor=pointer]
            - generic [ref=f2e301]:
              - generic [ref=f2e302]: Slot
              - text: "*"
              - combobox [ref=f2e303]:
                - option "Select" [selected]
            - generic [ref=f2e304]:
              - generic [ref=f2e305]: Appointment Priority
              - combobox [aria-hidden] [ref=f2e306]
              - combobox "Normal" [ref=f2e309] [cursor=pointer]
            - generic [ref=f2e311]:
              - generic [ref=f2e312]: Status *
              - combobox [ref=f2e313]:
                - option "Select" [selected]
                - option "Pending"
                - option "Approved"
                - option "Cancel"
            - generic [ref=f2e314]:
              - generic [ref=f2e315]: Discount Percentage
              - textbox [ref=f2e316]
            - generic [ref=f2e317]:
              - generic [ref=f2e318]: Live Consultant (On Video Conference)
              - text: "*"
              - combobox [ref=f2e319]:
                - option "No" [selected]
                - option "Yes"
            - generic [ref=f2e320]:
              - generic [ref=f2e321]: Payment Mode
              - combobox [ref=f2e322]:
                ...
                - option "Other"
            - generic [ref=f2e323]:
              - generic [ref=f2e324]: Message
              - textbox [ref=f2e325]
            - text: 
            - generic [ref=f2e328]:
              - generic [ref=f2e329]: Alternate Address
              - textbox "Alternate Address" [ref=f2e330]
        - generic [ref=f2e331]:
          - button "Cancel" [ref=f2e332] [cursor=pointer]
          - button " Save & Print" [ref=f2e333] [cursor=pointer]:
            - generic [ref=f2e334]: 
            - text: Save & Print
          - button " Save" [ref=f2e335] [cursor=pointer]:
            - generic [ref=f2e336]: 
            - text: Save
    - text:       
  - text: 
