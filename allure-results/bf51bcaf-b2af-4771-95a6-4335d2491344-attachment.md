...
Error: strict mode violation: locator('.sh-bubble-body .sh-bubble-msg') resolved to 2 elements:
    1) <div class="sh-bubble-msg">Appointment has been created for Patient: SARATH …</div> aka getByText('Appointment has been created')
    2) <div class="sh-bubble-msg">Patient: SARATH (1234) appointment status is appr…</div> aka getByText('Patient: SARATH (1234) appointment status is approved with Doctor: Sansa Gomez')
...
- generic [active] [ref=f2e1]:
  ...
  - generic:
    - generic [ref=f2e259]:
      - generic [ref=f2e260]: 
      - generic [ref=f2e262]:
        - heading "New Appointment Created" [level=4] [ref=f2e263]
        - generic [ref=f2e264]: "Appointment has been created for Patient: SARATH (1234). Appointment Date: 23/09/2026 12:43 PM With Doctor Name: Sansa Gomez (9008)."
        - generic [ref=f2e265]:
          - generic [ref=f2e266]: just now
          - link "View" [ref=f2e267] [cursor=pointer]:
            - /url: https://demo.smart-hospital.in/admin/systemnotification
      - button "Dismiss" [ref=f2e268] [cursor=pointer]:
        - generic [ref=f2e269]: 
    - generic [ref=f2e270]:
      - generic [ref=f2e271]: 
      - generic [ref=f2e273]:
        - heading "Appointment Status" [level=4] [ref=f2e274]
        - generic [ref=f2e275]: "Patient: SARATH (1234) appointment status is approved with Doctor: Sansa Gomez (9008) Date: 23/09/2026 12:43 PM."
        - generic [ref=f2e276]:
          - generic [ref=f2e277]: just now
          - link "View" [ref=f2e278] [cursor=pointer]:
            - /url: https://demo.smart-hospital.in/admin/systemnotification
      - button "Dismiss" [ref=f2e279] [cursor=pointer]:
        - generic [ref=f2e280]: 
  - text:    
```
